            ...
            <div className="sm:hidden">
              ...
              >
                <div className="relative mb-4">
                  <ListboxButton className="w-full appearance-none rounded-lg border-0 bg-panel py-2 pl-3 pr-10 text-left text-sm text-light-1000 shadow-sm ring-1 ring-inset ring-hairline focus:ring-2 focus:ring-inset focus:ring-hairline dark:text-dark-1000 dark:ring-hairline dark:focus:ring-hairline">
                  ...
                  <ListboxOptions className="absolute z-10 mt-1 w-full rounded-lg bg-panel py-1 text-sm shadow-lg ring-1 ring-inset ring-hairline dark:ring-hairline">
