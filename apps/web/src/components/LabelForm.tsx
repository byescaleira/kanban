                ...
                <>
                  <div className="relative mt-4">
                    ...
                    <Transition
                      ...
                      leaveTo="opacity-0"
                    >
                      <Listbox.Options className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-panel py-2 text-base shadow-lg ring-1 ring-hairline focus:outline-none dark:bg-dark-300 sm:text-sm">
                        {colours.map((colour, index) => (
                          <Listbox.Option
                            key={`colours_${index}`}
                            className="relative cursor-default select-none px-2 text-light-1000 dark:text-dark-1000"
                            value={colour}
                          >
                            {() => (
                              <>
                                <div className="flex items-center rounded-sm p-2 hover:bg-light-200 dark:hover:bg-dark-400">
                                  <span
