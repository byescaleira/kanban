                      ...
                      >
                        <div className="flex items-start gap-3">
                          <div className="mt-0.5 flex-shrink-0">
                            {result.type === "board" ? (
                              <HiFolder className="h-4 w-4 text-light-900 dark:text-dark-900" />
                            ) : (
                              <HiDocumentText className="h-4 w-4 text-light-900 dark:text-dark-900" />
                            )}
                          </div>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              {result.type === "card" &&
                                ...
                                workspace.cardPrefix && (
                                  <span className="flex-shrink-0 text-xs text-light-900 dark:text-dark-900">
