  ...
  return (
    ...
    >
      <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
        ...
        >
          <div className="pointer-events-auto w-full max-w-[350px] overflow-hidden rounded-xl border border-hairline bg-panel shadow-lg transition data-[closed]:data-[enter]:translate-y-2 data-[enter]:transform data-[closed]:opacity-0 data-[enter]:duration-300 data-[leave]:duration-100 data-[enter]:ease-out data-[leave]:ease-in dark:border-hairline dark:bg-dark-100 data-[closed]:data-[enter]:sm:translate-x-2 data-[closed]:data-[enter]:sm:translate-y-0">
            <div className="relative p-4">
              <div className="flex items-start">
                ...
                <div className="ml-3 w-0 flex-1 pt-0.5">
                  <p className="text-[12px] font-bold text-light-1000 dark:text-dark-950">
                    {popupHeader}
                  </p>
                  <p className="mt-1 text-[12px] text-light-900 dark:text-dark-900">
                    {popupMessage}
                  </p>
                </div>
