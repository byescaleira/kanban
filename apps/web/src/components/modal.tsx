      ...
      >
        ...
        <div className="fixed inset-0 z-50 w-screen overflow-y-auto">
          ...
          >
            ...
            >
              <Dialog.Panel
                className={`relative ${centered ? "" : positionFromTopMap[positionFromTop]} w-full transform rounded-lg border-2 border-hairline bg-panel text-left shadow-plate transition-all ${modalSizeMap[modalSize]}`}
              >
                {children}
              </Dialog.Panel>
            </Transition.Child>
