  ...
  return (
    <div className="p-5">
      ...
      <div className="mt-5 flex justify-end sm:mt-6">
        <button
          className="mr-4 inline-flex justify-center rounded-md border-2 border-hairline bg-panel px-3 py-2 text-sm font-semibold text-light-1000 shadow-sm focus-visible:outline-none dark:border-hairline dark:bg-dark-300 dark:text-dark-1000"
          onClick={() => closeModal()}
        >
          {t`Cancel`}
        </button>
