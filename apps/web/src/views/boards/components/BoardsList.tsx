    ...
    >
      {data?.map((board) => (
        ...
        >
          ...
          >
            <div className="group relative mr-5 flex h-[150px] w-full items-center justify-center rounded-md border border-dashed border-hairline bg-panel shadow-sm hover:bg-light-200 dark:border-hairline dark:hover:bg-dark-100">
              <PatternedBackground />
              <button
                onClick={(e) =>
              ...
              >
                {board.favorite ? (
                  <HiStar className="h-5 w-5 text-light-900 dark:text-dark-1000" />
                ) : (
                  <HiOutlineStar className="h-5 w-5 text-light-900 dark:text-dark-800" />
                )}
              </button>
              <p className="px-4 text-[14px] font-bold text-light-900 dark:text-dark-1000">
                {board.name}
              </p>
            </div>
          </Link>
