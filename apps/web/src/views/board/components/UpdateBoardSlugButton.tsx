...
const pathSeparator = (
  <div className="mx-1.5 h-4 w-px rotate-[20deg] bg-light-600 dark:bg-dark-600" />
);
  ...
  return (
    <Tooltip content={!canEdit ? t`You don't have permission` : undefined}>
      <button
        ...
        className="hidden cursor-pointer items-center gap-2 rounded-full border-2 bg-panel p-1 pl-4 pr-1 text-sm text-light-950 hover:bg-light-100 disabled:cursor-not-allowed disabled:opacity-60 dark:border-hairline dark:text-dark-900 dark:hover:bg-dark-100 xl:flex"
      >
